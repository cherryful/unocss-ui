          ...
          >
            ...
            >
              ...
              <p class="text-sm mx-2">
                ...
                <span class="font-bold text-primary-400" href="#">Upload Image</span>
                artical . 2m
              </p>
            </a>
          </div>
      ...
      <div class="relative">
        ...
        >
          ...
          >
            <a
              href="#"
              class="px-4 py-2 flex rounded-md text-sm text-gray-700 hover:bg-primary-600 hover:text-white"
            >
