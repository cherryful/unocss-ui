import{r as C,f as q,w as n,o as d,l as e,M as c,c as m,b as o,n as _,m as a,t as T,g as V,e as h,s as g,u as v,F as w,h as y}from"./index-cee64ba4.js";import{_ as N,P as D,r as k}from"./helper-d50f91ad.js";import{_ as p}from"./Sample.vue_vue_type_script_setup_true_lang-2c870790.js";const I={key:0,class:"pointer-events-auto max-w-sm w-full overflow-hidden rounded-lg bg-white shadow-lg ring-1 ring-black ring-opacity-5"},A={class:"p-4"},P={class:"flex items-start"},F={class:"shrink-0"},z={class:"ml-3 w-0 flex-1 pt-0.5"},E={class:"text-sm font-medium text-gray-900"},L=o("p",{class:"mt-1 text-sm text-gray-500"}," Anyone with a link can now view this file. ",-1),M={class:"flex flex-wrap gap-2"},Q={class:"flex flex-wrap items-center gap-2"},R=o("div",{class:"w-20"}," type ",-1),S={class:"flex flex-wrap items-center gap-2"},j=o("div",{class:"w-20"}," position ",-1),G={class:"flex flex-wrap items-center gap-2"},H=o("div",{class:"w-20"}," align ",-1),J={class:"flex items-center gap-2"},K=o("div",{class:"w-20"}," content ",-1),O={class:"flex items-center"},W=o("div",{class:"w-20"}," timeout ",-1),X={class:"w-36"},Y={class:"space-x-4 space-y-3"},Z={class:"space-x-4 space-y-3"},tt={class:"pointer-events-auto w-full overflow-hidden rounded-lg bg-white shadow-lg ring-1 ring-black ring-opacity-5"},st={class:"flex items-start p-4"},et={class:"shrink-0"},ot={class:"ml-3 w-0 flex-1 pt-0.5"},it={class:"text-sm font-medium text-gray-900"},nt=o("p",{class:"mt-1 text-sm text-gray-500"}," Anyone with a link can now view this file. ",-1),at={class:"space-x-4 space-y-3"},lt={class:"space-x-4 space-y-3"},rt={class:"space-x-4 space-y-3"},ut={class:"space-x-4 space-y-3"},mt={__name:"ToastDemo",setup(ct){const f={base:[`<UToast ref="toast_basic" />
