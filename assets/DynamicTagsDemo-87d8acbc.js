import{f as k,r as f,w as B,d as C,k as l,a as x,y as t,J as m,K as D,v as y,L as _,b as u,M as T,A as c,c as R,i as A,t as K,F as $,B as I,N as F,O as L,l as U}from"./index-c8a07d28.js";import{_ as M,P}from"./Playground-3098c67f.js";import{_ as g}from"./Sample.vue_vue_type_script_setup_true_lang-406ec9f8.js";const S=u("button",{class:"h-4 w-4 flex items-center rounded-full bg-red-500"},null,-1),E=["onKeyup","onBlur"],J={class:"flex gap-2"},O={class:"flex flex-wrap items-center gap-2"},j=u("div",{class:"w-16"}," max ",-1),q=u("button",{class:"h-4 w-4 flex items-center rounded-full bg-red-500"},null,-1),z=["onKeyup","onBlur"],X=k({__name:"DynamicTagsDemo",setup(G){const o=f(["Vue","React","Angular"]);function b(r,e){return I(F,{type:e%2?"primary":"success",closeable:!0,onClose:()=>o.value.splice(e,1)},{default:()=>r})}const d=f(""),v=f(null);B(v,r=>{L(()=>r==null?void 0:r.focus())});const i={base:["const tagNames = ref(['Vue', 'React', 'Angular'])",'<UDynamicTags v-model="tagNames" />'],max:['<UDynamicTags v-model="tagNames" :max="3" />'],closeable:['<UDynamicTags v-model="tagNames" :closeable="false" />'],renderTag:[`function renderTag(tag: string, index: number) {
  return h(UTag, {
