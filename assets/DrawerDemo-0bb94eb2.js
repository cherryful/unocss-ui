import{G as U,c as f,y as l,k as o,H as u,F as m,a as w,b as d,t as p,i as h,A as a,l as V}from"./index-c8a07d28.js";import{_ as k,P as $}from"./Playground-3098c67f.js";import{_}from"./Sample.vue_vue_type_script_setup_true_lang-406ec9f8.js";const b={class:"h-full w-full flex items-center justify-center"},C={class:"flex gap-4"},P={class:"flex flex-wrap items-center gap-2"},B=d("div",{class:"w-24"}," placement ",-1),T={class:"flex flex-wrap items-center gap-2"},R=d("div",{class:"w-24"}," width ",-1),L={class:"flex flex-wrap items-center gap-2"},N=d("div",{class:"w-24"}," duration ",-1),F={class:"flex gap-4"},A=d("div",{class:"h-full w-full flex items-center justify-center"}," duration-600 ",-1),E=d("div",{class:"h-full w-full flex items-center justify-center"}," width-1/2 ",-1),G=d("div",{class:"h-full w-full flex items-center justify-center"}," width-90% ",-1),H={class:"flex gap-4"},S=d("div",{class:"h-full w-full flex items-center justify-center"}," Left Placement ",-1),q=d("div",{class:"h-full w-full flex items-center justify-center"}," Right Placement ",-1),z=d("div",{class:"h-full w-full flex items-center justify-center"}," Top Placement ",-1),I=d("div",{class:"h-full w-full flex items-center justify-center"}," Bottom Placement ",-1),Q={__name:"DrawerDemo",setup(J){const c={placement:[`<UDrawer v-model="drawer.left" placement="left">
