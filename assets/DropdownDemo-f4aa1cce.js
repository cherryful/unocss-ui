import{r as b,B as c,d as h,k as e,a as _,y as t,I as i,A as l,b as d,c as w,i as B,t as y,F as k,l as p}from"./index-7b657caa.js";import{_ as D,P as V}from"./Playground-fffca84d.js";import{_ as m}from"./Sample.vue_vue_type_script_setup_true_lang-b37f74b7.js";const $={class:"flex flex-wrap items-center gap-2"},C=d("div",{class:"w-16"}," trigger ",-1),P={class:"flex gap-8"},F={__name:"DropdownDemo",setup(A){const n=b({trigger:"click",optionSlot:!1}),u={base:[`const options = [
  {
    label: 'Apple',
    value: 'apple',
