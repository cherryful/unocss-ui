import{r as U,c as f,l as e,w as t,F as y,o as m,x as a,m as l,t as I,b as s,e as A,s as v,u as b,h as d}from"./index-246a3e74.js";import{_ as V,P as x,r as $}from"./helper-b3984c9b.js";import{_ as p}from"./Sample.vue_vue_type_script_setup_true_lang-2cfd76e7.js";const k={class:"flex flex-wrap gap-2"},C={class:"flex flex-wrap items-center gap-2"},T=s("div",{class:"w-16"}," type ",-1),D={class:"flex items-center gap-2"},B=s("div",{class:"w-16"}," content ",-1),N={class:"space-y-3"},F={class:"space-y-3"},P={class:"space-y-3"},E={class:"space-y-3"},L={class:"space-y-3"},z={__name:"AlertDemo",setup(R){const c={type:[`<UAlert type="primary">
