import{r as b,d as B,k as i,a as d,y as s,a0 as c,c as _,b as n,n as v,A as l,t as m,j as V,i as w,F as y,l as h}from"./index-4ad6cd95.js";import{_ as C,P as q}from"./Playground-d4a03015.js";import{_ as p}from"./Sample.vue_vue_type_script_setup_true_lang-2886308f.js";const N={key:0,class:"pointer-events-auto max-w-sm w-full overflow-hidden rounded-lg bg-white shadow-lg ring-1 ring-black ring-opacity-5"},A={class:"p-4"},I={class:"flex items-start"},P={class:"shrink-0"},D={class:"ml-3 w-0 flex-1 pt-0.5"},F={class:"text-sm font-medium text-gray-900"},R=n("p",{class:"mt-1 text-sm text-gray-500"}," Anyone with a link can now view this file. ",-1),j={class:"flex flex-wrap gap-2"},z={class:"flex flex-wrap items-center gap-2"},E=n("div",{class:"w-20"}," type ",-1),L={class:"flex flex-wrap items-center gap-2"},Q=n("div",{class:"w-20"}," position ",-1),S={class:"flex flex-wrap items-center gap-2"},G=n("div",{class:"w-20"}," align ",-1),H={class:"flex items-center gap-2"},J=n("div",{class:"w-20"}," content ",-1),K={class:"flex items-center"},M=n("div",{class:"w-20"}," timeout ",-1),O={class:"w-36"},W={class:"flex gap-4"},X={class:"pointer-events-auto w-full overflow-hidden rounded-lg bg-white shadow-lg ring-1 ring-black ring-opacity-5"},Y={class:"flex items-start p-4"},Z={class:"shrink-0"},tt={class:"ml-3 w-0 flex-1 pt-0.5"},et={class:"text-sm font-medium text-gray-900"},st=n("p",{class:"mt-1 text-sm text-gray-500"}," Anyone with a link can now view this file. ",-1),ot={class:"flex gap-4"},it={class:"flex gap-4"},nt={class:"flex gap-4"},lt={class:"flex gap-4"},ft={__name:"ToastDemo",setup(at){const f={base:[`<UToast ref="toast_basic" />
