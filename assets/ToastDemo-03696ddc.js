import{r as x,d as B,k as i,a as m,y as s,a0 as c,c as _,b as l,n as w,A as a,t as p,j as V,i as y,F as b,l as g}from"./index-86feeedd.js";import{_ as C,P as q}from"./Playground-d950f940.js";import{_ as d}from"./Sample.vue_vue_type_script_setup_true_lang-37fccdd2.js";const N={key:0,class:"pointer-events-auto max-w-sm w-full overflow-hidden rounded-lg bg-white shadow-lg ring-1 ring-black ring-opacity-5"},I={class:"p-4"},P={class:"flex items-start"},A={class:"shrink-0"},D={class:"ml-3 w-0 flex-1 pt-0.5"},F={class:"text-sm font-medium text-gray-900"},R=l("p",{class:"mt-1 text-sm text-gray-500"}," Anyone with a link can now view this file. ",-1),j={class:"flex flex-wrap gap-2"},z={class:"flex flex-wrap items-center gap-2"},E=l("div",{class:"w-20"}," type ",-1),L={class:"flex flex-wrap items-center gap-2"},Q=l("div",{class:"w-20"}," position ",-1),S={class:"flex flex-wrap items-center gap-2"},G=l("div",{class:"w-20"}," align ",-1),H={class:"flex items-center gap-2"},J=l("div",{class:"w-20"}," content ",-1),K={class:"flex items-center"},M=l("div",{class:"w-20"}," timeout ",-1),O={class:"w-36"},W={class:"flex gap-4"},X={class:"pointer-events-auto w-full overflow-hidden rounded-lg bg-white shadow-lg ring-1 ring-black ring-opacity-5"},Y={class:"flex items-start p-4"},Z={class:"shrink-0"},tt={class:"ml-3 w-0 flex-1 pt-0.5"},et={class:"text-sm font-medium text-gray-900"},st={class:"mt-1 text-sm text-gray-500"},ot={class:"flex gap-4"},it={class:"flex gap-4"},lt={class:"flex gap-4"},nt={class:"flex gap-4"},ft={__name:"ToastDemo",setup(at){const f={base:[`<UToast ref="toast_basic" />
