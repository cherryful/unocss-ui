import{r as b,f as B,w as i,o as d,l as s,P as p,c as _,b as n,n as g,q as a,t as m,g as V,e as w,F as y,i as v}from"./index-1c61a7e1.js";import{_ as C,P as q}from"./Playground-8262a633.js";import{_ as f}from"./Sample.vue_vue_type_script_setup_true_lang-f964f82c.js";const N={key:0,class:"pointer-events-auto max-w-sm w-full overflow-hidden rounded-lg bg-white shadow-lg ring-1 ring-black ring-opacity-5"},I={class:"p-4"},P={class:"flex items-start"},A={class:"shrink-0"},D={class:"ml-3 w-0 flex-1 pt-0.5"},F={class:"text-sm font-medium text-gray-900"},R=n("p",{class:"mt-1 text-sm text-gray-500"}," Anyone with a link can now view this file. ",-1),z={class:"flex flex-wrap gap-2"},E={class:"flex flex-wrap items-center gap-2"},L=n("div",{class:"w-20"}," type ",-1),Q={class:"flex flex-wrap items-center gap-2"},S=n("div",{class:"w-20"}," position ",-1),j={class:"flex flex-wrap items-center gap-2"},G=n("div",{class:"w-20"}," align ",-1),H={class:"flex items-center gap-2"},J=n("div",{class:"w-20"}," content ",-1),K={class:"flex items-center"},M=n("div",{class:"w-20"}," timeout ",-1),O={class:"w-36"},W={class:"flex gap-4"},X={class:"pointer-events-auto w-full overflow-hidden rounded-lg bg-white shadow-lg ring-1 ring-black ring-opacity-5"},Y={class:"flex items-start p-4"},Z={class:"shrink-0"},tt={class:"ml-3 w-0 flex-1 pt-0.5"},et={class:"text-sm font-medium text-gray-900"},st=n("p",{class:"mt-1 text-sm text-gray-500"}," Anyone with a link can now view this file. ",-1),ot={class:"flex gap-4"},it={class:"flex gap-4"},nt={class:"flex gap-4"},lt={class:"flex gap-4"},ct={__name:"ToastDemo",setup(at){const c={base:[`<UToast ref="toast_basic" />
