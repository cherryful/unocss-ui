import{r as i,d as f,k as t,a as _,y as a,b as u,t as v,a1 as d,K as h,A as n,l as A}from"./index-d10fb719.js";import{_ as k,P as x}from"./Playground-84923872.js";import{_ as b}from"./Sample.vue_vue_type_script_setup_true_lang-9ce7f446.js";const U={class:"w-full"},g={class:"mb-3"},y={class:"flex items-center gap-1"},T=u("span",{class:"i-mdi:lightning-bolt h-4 w-4"},null,-1),w={class:"flex gap-2"},C={class:"flex items-center gap-1"},N=u("span",{class:"i-mdi:lightning-bolt h-4 w-4"},null,-1),K={__name:"TreeDemo",setup($){const B=i([]),m=i([]),r=i([]),s=i({checkedValues:[],selectable:!0,cascade:!0,custom:!1}),c={base:[`const options = [
  {
    label: '1',
    value: 1,
    children: [
